...
#---------------------------------------
#grid approach
mygrid1 = {'alpha' : [0.5,0.7,1.0,1.5,2.0,3.0,4.0,5.0,20,30,50,100]
        }

mylr_grid_estimator = model_selection.GridSearchCV(mylr,mygrid1, cv=20)
...
model_selection.cross_val_score(mylr, X_train, y_train, cv=10,
